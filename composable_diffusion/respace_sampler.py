...
from .sampler_gd import Sampler_GaussianDiffusion
...
class Sampler_SpacedDiffusion(Sampler_GaussianDiffusion):
    """
    ...
    def __init__(self, use_timesteps, **kwargs):
        ...
        base_diffusion = Sampler_GaussianDiffusion(**kwargs)  # pylint: disable=missing-kwoa
